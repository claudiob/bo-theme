...
function the_feeds() {
  if (is_category() || is_single()) {
    echo '    <link title="'. get_h2_by_slug($GLOBALS['my_slug'], false) .' (RSS 2.0)"  href="'. get_category_feed_link($GLOBALS['my_cat']->term_id, 'rss2') .'" rel="alternate" type="application/rss+xml" />'."\n";
    # echo '    <link title="'. get_h2_by_slug($GLOBALS['my_slug'], false) .' (Atom 0.3)" href="'. get_category_feed_link($GLOBALS['my_cat']->term_id, 'atom') .'" rel="alternate" type="application/atom+xml" />'."\n";
  }
  echo '    <link title="Todo el contenido de Boxoffice.es (RSS 2.0)"  href="'. get_bloginfo('rss2_url') .'" rel="alternate" type="application/rss+xml" />'."\n";
  # echo '    <link title="Todo el contenido de Boxoffice.es (Atom 0.3)" href="'. get_bloginfo('atom_url') .'" rel="alternate" type="application/atom+xml" />'."\n";
